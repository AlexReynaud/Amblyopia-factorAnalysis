...
hold on
% plot(data.frequencies.Reynaud,mean(mean(data.sensitivities.noise_patches.amblyopes.Reynaud.tempFE,3),1),'k')

plot(data.frequencies.Zhou_Beylerian,mean(mean(data.sensitivities.noise_patches.amblyopes.Zhou_Beylerian.tempFE,3),1),'r')
plot(data.frequencies.Zhou_Beylerian,mean(mean(data.sensitivities.noise_patches.amblyopes.Zhou_Beylerian.tempAE,3),1),'r')

plot(data.frequencies.Gao,mean(mean(data.sensitivities.noise_patches.amblyopes.Gao.tempFE,3),1),'r')
plot(data.frequencies.Gao,mean(mean(data.sensitivities.noise_patches.amblyopes.Gao.tempAE,3),1),'r')
